...
<html lang="en">
	<head>
	    ...
	    <title>MSW</title>
	    <link rel="shortcut icon" href="<?= asset_url(); ?>img/tlogo.png" type="image/x-icon">
         ...
         <nav class="navbar navbar-custom">
           <div class="container-fluid">
             ...
             <div class="navbar-header">
               ...
               <a class="navbar-brand" href="<?= base_url();?>"><img src="<?= asset_url(); ?>img/tlogo.png" alt="SCAD" class="img-responsive" /></a>
             ...
             <div class="collapse navbar-collapse" id="custom-toggle-navigation">
               ...
               <ul class="nav navbar-nav navbar-right">
                 ...
                 <li><a href="<?= base_url();?>welcome/services">MSW Services</a></li>
              
              <li><a href="<?= base_url();?>welcome/portfolio">MSW Portfolio</a></li>
              <li><a href="<?= base_url();?>welcome/blog">Recent Blogs</a></li>
